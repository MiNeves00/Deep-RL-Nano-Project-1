...
WEIGHT_DECAY = 0        # L2 weight decay
afc1_units=200        # Actor FC1 Units
afc2_units=100        # Actor FC2 Units
cfc1_units=200        # Critic FC1 Units
cfc2_units=100        # Critic FC2 Units
...
class Agent():
    ...
    def __init__(self, state_size, action_size, random_seed=10, actor_fc1_units=128, actor_fc2_units=128, critic_fc1_units=128, critic_fc2_units=128, buffer_size=int(1e5), batch_size=128, gamma=0.99, tau=1e-3 , bn_mode=0,
        ...
        print("\nParameters Used: state_size={} action_size={} random_seed={} actor_fc1_units={} actor_fc2_units={} critic_fcs1_units={} critic_fc2_units={} buffer_size={} batch_size={} gamma={} tau={} bn_mode={} lr_actor={} lr_critic={} weight_decay={} add_ounoise={} mu={} theta={} sigma={} \n".format(state_size, action_size, random_seed, 
        ...
        self.critic_local = Critic(state_size, action_size, random_seed, fcs1_units=critic_fc1_units, fc2_units=critic_fc2_units).to(device)
        self.critic_target = Critic(state_size, action_size, random_seed, fcs1_units=critic_fc1_units, fc2_units=critic_fc2_units).to(device)
